            ...
            <div class="grid grid-cols-3 h-80 gap-6 text-black">
              ...
              <div class="col-span-3 px-4 lg:col-span-1 h-fit pb-10 bg-white shadow-md rounded-md pt-10 border border-[#e1e1e1]">
                ...
                <div class="flex items-center justify-center gap-2 text-white text-nowrap mt-4">
                  <div id="changeProfileBtn" class="px-4 py-1 bg-[#fa7011] rounded-md cursor-pointer">Change Profile</div>
                  <div id="removeProfileBtn" class="px-4 py-1 bg-red-500 rounded-md cursor-pointer">Remove Profile</div>
                </div>
...
<script>
  ...
  document.getElementById("removeProfileBtn").addEventListener("click", function () {
    ...
    document.querySelector("img.rounded-full").src = "{{ asset('/Assets/user-profile-profilepage.png') }}"; // Reset to default
  });
</script>